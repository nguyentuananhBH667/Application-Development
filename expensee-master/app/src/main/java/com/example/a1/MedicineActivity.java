...
public class MedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addExpenseButton.setOnClickListener(v -> {
            Intent intent = new Intent(MedicineActivity.this, AddExpenseActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            int expenseImageResId = data.getIntExtra("expense_image_res_id", R.drawable.ic_medicine); // Default image
    ...
    private void showEditDeleteDialog(View expenseItemView, String title, String amount, String date, int imageResId, int position) {
        ...
        builder.setItems(new CharSequence[]{"Edit", "Delete"}, (dialog, which) -> {
            switch (which) {
                case 0: // Edit
                    Intent editIntent = new Intent(MedicineActivity.this, AddExpenseActivity.class);
